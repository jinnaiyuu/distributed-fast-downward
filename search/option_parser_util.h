...
// HDA*
template <>
struct TypeNamer<DistributionHash *> {
    static std::string name() {
...
// HDA*
template <>
struct TypeDocumenter<DistributionHash *> {
    static std::string synopsis() {
        return "TODO: DistributionHash document";
    }
};

template <>
struct TypeDocumenter<CutStrategy *> {
    static std::string synopsis() {
        return "TODO: CutStrategy document";
    }
};

template <>
struct TypeDocumenter<Sparsity *> {
    static std::string synopsis() {
        return "TODO: Sparsity document";
    }
};
