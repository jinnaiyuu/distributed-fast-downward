#ifndef MERGE_AND_SHRINK_SHRINK_CLIQUE_H
#define MERGE_AND_SHRINK_SHRINK_CLIQUE_H
...
class ShrinkClique : public ShrinkBucketBased {
public:
...
public:
    ShrinkClique(const Options &opts);
    virtual ~ShrinkClique();
